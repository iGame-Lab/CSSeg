...
def main(opt, logger):
    ...
    cnt = 0
    chutu_cam_list = ['BraTS2021_00052_73.png', 'BraTS2021_00052_98.png', 'BraTS2021_00078_95.png', 'BraTS2021_00078_105.png']
    video_list = ['BraTS2021_00078']
...
#26,38
        ...
        for img_name, label_data in zip(frame_names, label):
            if img_name not in chutu_cam_list:
                continue
            cnt += 1
            ...
            # 保存原始的cam_maskC:/Users/Administrator/Desktop/vis_supply/slice_73.png
        ...
        for t in np.arange(0,len(cam_list)):
            concatenate_images_and_save(cam_list[t],ori_sam_mask[t],SAM_list[t],label_res_list[t],output_path=os.path.join(video_output_path, f"{t}.png"))
        for t in np.arange(0, len(cam_list)):
            concatenate_images_and_save(cam_list[t],
                                        output_path=os.path.join(video_output_path, f"{t}.png"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_out_path', default="F:/brats/chutu")
    parser.add_argument('--sam1-dir', default="F:/brats/box_stack_sam1")
    parser.add_argument('--npz-dir', default="F:/brats/chutu")
