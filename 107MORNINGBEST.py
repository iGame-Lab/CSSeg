...
def main(opt, logger):
    ...
    for video_dir in tqdm(video_path, desc="Processing Videos"):  # 遍历所以的视频
        ...
        for img_name, label_data in zip(frame_names, label):
            ...
            # sam_mask = np.load(os.path.join("F:/brats/box_stack_sam1_stack/使用二次sam的最优", img_name.split('.')[0] + '.npz'))[
            #     'caa_sam1_stack_pred']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_out_path', default="F:/brats/Train_Sets/val/val/video_twosam_addcam_1021")
    parser.add_argument('--sam1-dir', default="/root/data1/brats/box_stack_sam1")
    parser.add_argument('--npz-dir', default="F:/brats/Train_Sets/val/val/twosam_addcam_1021")
